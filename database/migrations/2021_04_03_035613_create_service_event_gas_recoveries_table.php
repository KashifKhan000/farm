...
class CreateServiceEventGasRecoveriesTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('service_event_gas_recoveries', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('service_event_gas_recoveries');
    }
}
