...
class UpdateServiceEventShutdownMothball extends ApiRequest
{
    /**
    ...
    public function rules()
    {
        return [
            ...
            'type' => 'in:Shutdown,Mothball',
            'parts_required' => 'string',
            'actions' => 'nullable|required_without:actions_other|in:Other,Bypass,Relocate,Remove,Repair,Replace',
