...
class PersonalAccessTokenPolicy
{
    ...
    /**
     * Determine whether the user can refresh the token.
     *
     * @param \App\Models\User $user
     * @param \App\Models\PersonalAccessToken $model
     *
     * @return mixed
     */
    public function refresh(User $user, PersonalAccessToken $model)
    {
        if ($user->id === $model->tokenable_id) {
            return true;
        }

        return $user->hasAbility('refresh', PersonalAccessToken::class);
    }
